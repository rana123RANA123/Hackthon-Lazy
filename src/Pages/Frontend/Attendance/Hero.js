  ...
  return (
    <>
      ...
      <div className="container mt-4">
        <div className="row">
          <div className="col d-flex justify-content-center">
            <Link to='/inActive' className='btn btn-light' style={{fontSize:"23px"}}>Go To Check Absent</Link>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <div className="row">
          <div className="col">
            <h3 className='text-center my-4 mt-5'>Present Students ({documents.length})</h3>
          </div>
        </div>
      </div>
